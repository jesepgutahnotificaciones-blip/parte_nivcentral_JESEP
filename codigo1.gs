  ...
  // ============================================================
  // ORDEN DEL LISTADO POR GRADO
  // Se ordena exclusivamente por el grado (columna C = GR).
  // NO se ordena por nombre.
  // ============================================================
  ...
  ORDEN_GRADOS_TURNO.forEach(function(grado, indice) {
    posicionGrado[grado] = indice;
  });
  ...
  resultados.sort(function(a, b) {
    ...
    const posicionA = Object.prototype.hasOwnProperty.call(
      posicionGrado,
      gradoA
    )
      ? posicionGrado[gradoA]
      : 999;

    const posicionB = Object.prototype.hasOwnProperty.call(
      posicionGrado,
      gradoB
    )
      ? posicionGrado[gradoB]
      : 999;
